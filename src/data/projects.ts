...
export const projectsData: IProject[] = [
  {
    ...
    tech: ['Angular', 'Java Spring Boot', 'Azure SQL', 'GIS'],
    image: '/SECOP.png',
  ...
  },
  {
    ...
    tech: ['Angular', 'Java Spring Boot', 'Azure', 'Kubernetes'],
    image: '/SECOP.png',
  ...
  },
  {
    ...
    tech: ['Angular', 'Java Spring Boot', 'PostgreSQL', 'Microservices'],
    image: '/SOL.png',
  ...
  },
  {
    ...
    tech: ['React', 'Python', 'PostgreSQL', 'Machine Learning'],
    image: '/nplbrasil.png',
